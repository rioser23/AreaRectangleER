...
/**
 * Calculates the area of a rectangle from user input of width & length
 * dimensions.
 *
 */
public class AreaRectangleER {
	/**
	...
	public static void main(String[] args) {
		...
		if ((width = getWidth()) != null && (length = getLength()) != null) {
			JOptionPane.showMessageDialog(null, new Rectangle(width, length), new String("Rectangle Area"),
					JOptionPane.INFORMATION_MESSAGE);
		} else
			JOptionPane.showMessageDialog(null, "User canceled operation.", new String("Rectangle Area"),
					JOptionPane.INFORMATION_MESSAGE);
		System.exit(0);
	}
